...
- Updated service worker cache and all module asset versions to V12.1.
...
## V12.1 — Cloud User & Roles Manager
...
- Includes `supabase_v12_1_user_roles_manager.sql`; run it once before using the manager.
