const CACHE_NAME='nuvexa-hub-v11-7-modular-foundation';
const CORE=['./assets/css/app.css?v=11.7','./assets/js/app.js?v=11.7','./manifest.webmanifest?v=11.6','./favicon.ico?v=11.6','./assets/branding/favicon-nuvexa-v10-2-32.png?v=11.6','./assets/branding/favicon-nuvexa-v10-2-48.png?v=11.6','./assets/branding/apple-touch-icon-nuvexa-v10-2.png?v=11.6','./assets/branding/logo-main.png','./assets/branding/app-icon-192.png?v=11.6','./assets/branding/app-icon-512.png?v=11.6'];
